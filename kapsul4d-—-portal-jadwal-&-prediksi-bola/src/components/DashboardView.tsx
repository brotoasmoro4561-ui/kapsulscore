...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {/* ============================================================
          🔥 FOOTER TEXT - DI PRODUKSI OLEH SEO KRITING X KAPSUL4D
          LETAK: SETELAH PROMO BANNER, SEBELUM BIG MATCH SLIDER
          ============================================================ */}
      <div className="relative my-4 anim-in" style={{ animationDelay: '0.1s' }}>
        {/* Garis dekoratif kiri */}
        <div className="absolute left-0 top-1/2 w-[12%] h-[1px] bg-gradient-to-r from-transparent to-cyan-400/40 hidden md:block"></div>
        ...
        <div className="absolute right-0 top-1/2 w-[12%] h-[1px] bg-gradient-to-l from-transparent to-cyan-400/40 hidden md:block"></div>
      </div>
